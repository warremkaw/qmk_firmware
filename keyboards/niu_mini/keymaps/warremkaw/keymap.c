...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_NRML] = LAYOUT_ortho_4x12(
        ...
        KC_LCTL, KC_0,    KC_LALT, KC_LGUI, LWR,     KC_SPC,  KC_SPC,  RSE,     KC_RGUI, KC_0,    ARW,     KC_RCTL 
    ),

    [_LWR] = LAYOUT_ortho_4x12(
        KC_GRV,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_MINS, KC_EQL,  _______, \
        XXXXXXX, KC_LPRN, KC_RPRN, KC_LBRC, KC_RBRC, KC_LPRN, KC_RPRN, KC_LCBR, KC_RCBR, KC_PIPE, KC_BSLS, XXXXXXX, \
