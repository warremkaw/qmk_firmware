...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_60_ansi(
    ...
    KC_LCTL, KC_LALT, KC_LGUI,                           KC_SPC,                             KC_RGUI, MO(1),   MO(2),   KC_RCTL
  ),
  ...
  [1] = LAYOUT_60_ansi(
    ...
    _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_LEFT, KC_DOWN,  KC_UP,   KC_RIGHT, _______, _______,          _______, \
    _______, KC_VOLD, KC_VOLU, KC_MUTE, _______, _______, _______, _______,  _______, _______,  _______,                   _______, \
    _______, _______, _______,                            _______,                              _______, _______, _______, _______
  ),

  [2] = LAYOUT_60_ansi(
    KC_GRV,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_DELETE, \
