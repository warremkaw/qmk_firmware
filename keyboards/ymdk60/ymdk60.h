...
#define LAYOUT_60_ansi( \
    ...
    { K40, K41, K42, KC_NO, KC_NO, KC_NO, KC_NO, K45, KC_NO, K4A, K4B, KC_NO, K4C, K4D } \
}

    // { KC_0, KC_1, KC_2, KC_3,    KC_4,    KC_5, KC_6,    KC_7,    KC_8,    KC_9,    KC_A, KC_B, KC_C, KC_D } 
    // { K40, K41, K42, KC_NO,    KC_NO,    K45, K45,    KC_NO,    K4A,    K4A,    KC_NO, K4B, K4C, K4D }  
    //
    // 7 = space
    // 3,8 = space stabalizers?
    // 9,a,c,d = fn keys
