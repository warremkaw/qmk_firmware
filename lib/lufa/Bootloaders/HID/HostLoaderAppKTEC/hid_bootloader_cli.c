...
{
	teensy_close();
	libusb_teensy_handle = open_usb_device(0x1209, 0x2327);

	if (!libusb_teensy_handle)
		libusb_teensy_handle = open_usb_device(0x1209, 0x2328);
...
int hard_reboot(void)
{
	...
	rebootor = open_usb_device(0x1209, 0x2327);

	if (!rebootor)
		rebootor = open_usb_device(0x1209, 0x2328);
...
{
	teensy_close();
	win32_teensy_handle = open_usb_device(0x1209, 0x2327);

	if (!win32_teensy_handle)
		win32_teensy_handle = open_usb_device(0x1209, 0x2328);
...
{
	teensy_close();
	iokit_teensy_reference = open_usb_device(0x1209, 0x2327);

	if (!iokit_teensy_reference)
		iokit_teensy_reference = open_usb_device(0x1209, 0x2328);
...
{
	teensy_close();
	uhid_teensy_fd = open_usb_device(0x1209, 0x2327);

	if (uhid_teensy_fd < 0)
		uhid_teensy_fd = open_usb_device(0x1209, 0x2328);
...
int hard_reboot(void)
{
	...
	rebootor_fd = open_usb_device(0x1209, 0x2327);

	if (rebootor_fd < 0)
		rebootor_fd = open_usb_device(0x1209, 0x2328);
